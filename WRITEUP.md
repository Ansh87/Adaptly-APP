...
2. **Diagnose.** A deterministic engine (`src/agent.js` — no AI, fully unit-testable)
   turns that evidence into a mastery score (0–100, or "Not assessed" until there's
...
5. **Measure & adapt.** Every answer updates mastery immediately. The next time the
...
what to work on, without being asked, and the decision is grounded in the student's
own logged evidence — never invented. A skill with no direct practice evidence stays
labeled "Not assessed" rather than showing a fabricated percentage.
